...
function articlePagination () {
  var idx = location.href.lastIndexOf('/articles/');
  if(idx < 0){
    return;
  }
  var href = location.href.substr(idx);
  $('.article-pager').find('[href="'+href+'"]').parent().addClass('active').siblings().removeClass('active');
}
